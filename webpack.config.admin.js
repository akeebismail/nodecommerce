...
module.exports = {
    entry: {
        ...
        vendor : [
            "react", "react-dom", "react-redux","redux-thunk",
            "react-router-dom", "react-dropzone","redux",
            "redux-form", "redux-form-material-ui","material-ui"
        ]
    },
    performance: {
        hints: false
                ...
                use: [
                    MiniCssExtractPlugin.loader,
                    {
                        ...
                        options: {
                            modules: true,
                            importLoaders: true,
                            localIndetName: '[name]__[local]__[hash:bash64:5]'
                        }
                    },
                    'postcss-loader'
                ]
